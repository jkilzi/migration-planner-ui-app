          ...
          <Stack hasGutter>
            ...
            <StackItem>
              <Checkbox
                ...
                label={<>{"Run workloads on control plane nodes"} <PopoverIcon noVerticalAlign bodyContent={'Enable this to use spare capacity on control plane nodes for your workloads. This reduces the total number of nodes needed but may impact cluster management stability.'} /></>}
