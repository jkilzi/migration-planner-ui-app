...
export const createMockClusterRequirementsRequest = (
  ...
  overCommitRatio: overrides.overCommitRatio ?? mockClusterRequirementsRequest.overCommitRatio,
  workerNodeCPU: overrides.workerNodeCPU ?? mockClusterRequirementsRequest.workerNodeCPU,
  workerNodeMemory: overrides.workerNodeMemory ?? mockClusterRequirementsRequest.workerNodeMemory,
  controlPlaneSchedulable: overrides.controlPlaneSchedulable ?? mockClusterRequirementsRequest.controlPlaneSchedulable,
});
