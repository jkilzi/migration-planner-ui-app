...
export const HA_OPTIONS: {
  ...
  },
  {
    ...
    helpText:
      'Three replicas ensure availability during maintenance windows.',
  },
];
...
export const CONTROL_PLANE_OPTIONS = {
  yes: {
    label: 'Yes',
    description: 'Lower cost. Uses spare capacity on management nodes for your VMs.',
  },
  no: {
    label: 'No',
    description: 'Higher stability. Keeps cluster management isolated from your app workloads.',
  },
};
...
export const DEFAULT_FORM_VALUES: SizingFormValues = {
  ...
  customMemoryGb: 32,
  haReplicas: 3,
  overcommitRatio: 6, // High density (1:6) - matches Figma default
